  ...
  <body>
    <header>
      <div class="container">
        ...
        <img class="logo" src="/images/purpur.svg" alt="Purpur Logo - Pride Month" />
        ...
        <a class="button download-button blue-button" href="/api/v1/purpur/1.17/latest/download">Download</a>
