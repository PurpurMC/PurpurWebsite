...
<html lang="en">
  <head>
    ...
    <link rel="icon" type="image/x-icon" href="assets/purpur.svg" />
  ...
  <body>
    <header>
      <div class="container">
        ...
        <img class="logo" src="assets/purpur.svg" alt="Purpur Logo" />
        <a href="downloads" class="button download-button blue-button">Download</a>
        <p>Purpur is a drop in replacement for any Spigot/Paper server designed to bring
         you superior configuration, ultimate gameplay features, and the best blazing fast optimizations.</p>
      </div>
    </header>
    <div class="row-one">
      <div class="container group">
        <div class="block">
          <img class="icon" src="assets/documentation.svg" alt="Fully Documented" />
        ...
        <div class="block">
          <img class="icon" src="assets/opensource.svg" alt="Free and Open Source" />
    ...
    <div class="row-two">
      <div class="container group">
        <div class="block">
          <img class="icon" src="assets/warning.svg" alt="Found a bug? File it!" />
        ...
        <div class="block">
          <img class="icon" src="assets/discord.svg" alt="Get Involved" />
          <h3>Get Involved</h3>
