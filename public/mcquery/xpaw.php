...
class xpaw
{
	...
	public function Connect( )
	{
		...
		if( !$this->Socket )
		{
			...
			throw new xpawexception( "Failed to connect or create a socket: $errno ($errstr)" );
		}
	...
	public function Query( )
	{
		...
		do
		{
			...
			{
				throw new xpawexception( 'Server read timed out' );
			}
			...
			if (!$block)
			{
				throw new xpawexception( 'Server returned too few data' );
			}
		...
		if( $Data === FALSE )
		{
			throw new xpawexception( 'Server didn\'t return any data' );
		}
		...
		if( JSON_Last_Error( ) !== JSON_ERROR_NONE )
		{
			...
			{
				throw new xpawexception( JSON_Last_Error_Msg( ) );
			}
			else
			{
				throw new xpawexception( 'JSON parsing failed' );
			}
	...
	private function ReadVarInt( )
	{
		...
		while( true )
		{
			...
			if( $j > 5 )
			{
				throw new xpawexception( 'VarInt too big' );
			}
